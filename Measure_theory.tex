...
\end{proof}
\begin{exercise}
Suppose \( f : \mathbb{R} \to \mathbb{R} \) is in \( L^1 \). Let \( \varepsilon > 0 \). Using Question 42, show there exists a continuous function \( g : \mathbb{R} \to \mathbb{R} \) such that 
\[
\|f - g\|_1 < \varepsilon,
\]
i.e., 
\[
\int_{-\infty}^{\infty} |f(x) - g(x)| \,dx < \varepsilon.
\]
\end{exercise}
